...
//        $client_location  = \App\System::geolocation($client_ip);
    ...
    public static function GetAllRouteNameList(){
        $route_list = array_map(function (\Illuminate\Routing\Route $route) {
            return $route->getName();}, (array) \Route::getRoutes()->getIterator());

        return $route_list;
    }

    /**********************************************************
    ## GetAllRouteNameListWithPrefix
     *************************************************************/

    public static function GetAllRouteNameListWithPrefix($prefix){
