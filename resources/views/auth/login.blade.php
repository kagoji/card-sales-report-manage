...
<!-- start: HEAD -->
<head>
    <title>Login | Sales Reports</title>
    <!-- start: META -->
    <meta charset="utf-8" />
...
<div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
    <div class="logo" style="color: #fff">
        Sales <i class="clip-lamp"></i> Reports
    </div>
    <!-- start: LOGIN BOX -->
    <div class="box-login btn-squared">
        ...
        <form class="form-login" action="{{ url('/auth') }}" method="post">
    ...
    <!-- start: COPYRIGHT -->
    <div class="copyright">
        <span style="color: #fff">&copy; Copyright {{date('Y')}} by South East Bank Ltd.</span>
    </div>
    <!-- end: COPYRIGHT -->
</div>
