    ...
    <div class="col-sm-12">
        <div class="tabbable">
            <ul id="myTab" class="nav nav-tabs tab-bricky">
                <li class="">
                    <a href="{{url('/role-type/create')}}">
                        <i class="green fa fa-bell"></i> Add Role Type
                    </a>
                </li>
                <li class="active">
                    <a href="{{url('/role-type/list')}}">
                        <i class="green clip-feed"></i> Role Type List
                    </a>
                </li>
            </ul>
                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                    @if (isset($role_type_list) && count($role_type_list)>0)
                                    @foreach ($role_type_list as $key => $role_type)
                                    <tr>
                                        <td>{{ $key+1 }}</td>
                                        <td>{{ $role_type->role_type }}</td>
                                        <td style="width:18%">
                                            <div class="btn-group">
