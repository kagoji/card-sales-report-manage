            ...
            <div class="tabbable">
                ...
                <div class="tab-content">
                                ...
                                <div class="user-left">
                                    <div class="center">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <form action="{{url('/me/profile/image/update')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div id="panel_edit_account" class="tab-pane in {{isset($tab) && ($tab=='panel_edit_account') ? 'active' : ''}}">
                        <form action="{{url('me/profile/update')}}" method="post" enctype="multipart/form-data" role="form" id="form">
                            <div class="row">
                                <div class="col-md-12">
                                    <h3>Account Info</h3>
                                    <hr>
                        ...
                        <div class="row">
                            <div class="col-md-12 change_password">
                                ...
                                <div class="col-md-8 info"><h1><i class="fa fa-lock"></i> {{isset($user_info->name) ? $user_info->name : ''}}</h1>
                                    <form action="{{url('me/change/password')}}" method="post" enctype="multipart/form-data">
                                        <input type="hidden" name="_token" value="{{csrf_token()}}" >
                                        <div class="row">
